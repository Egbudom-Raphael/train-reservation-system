    ...
    def create_widgets(self):
        ...
        def test():
            if username.get() == "Test".lower() and passwd_entry.get() == "12345":
                ...
                wrong_details= tkinter.Label(frame2, text='Incorrect username or password', font="Poppins 9", fg='red', bg="#110445")
                wrong_details.place(x=550, y=210)


        self.background_img = PhotoImage(file = f"railly logo.png")
        self.background_lbl = Label(frame2, image=self.background_img, bg="#110445")
        self.background_lbl.place(x=50, y=45)
        ...
        self.customertext_lbl = Label(frame2, text="Customer Login", bg="#110445",
                                       font = ("Poppins ExtraBold", int(26.0)), fg="white")
        self.customertext_lbl.place(x=510, y=180)
...
frame2 = Frame(root, height=720, width=1280, bg="#110445")
